...
<b>Linux</b>
```bash
  git clone https://github.com/GiovanniMatos/Flask_MySQL.git && cd Flask_MySQL && pip install python3-venv && python -m venv venv && source venv/bin/activate && cd .. && pip3 install virtualenv Flask python-dotenv pymysql folium cryptocode
```
<b>Windows</b>
```bash
  mkdir Flask_MySQL
